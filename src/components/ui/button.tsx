  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[10px] text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        landing:
          "bg-white text-slate-900 border border-slate-200 shadow-sm hover:bg-blue-600 hover:text-white hover:border-blue-600 focus-visible:ring-blue-600",
        headerCta:
          "h-10 px-5 rounded-[10px] border border-slate-200 bg-white text-slate-900 shadow-sm hover:bg-blue-600 hover:text-white hover:border-blue-600 focus-visible:ring-blue-600",
      },
      size: {
